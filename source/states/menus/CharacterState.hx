...
class CharacterState extends GameState {
    ...
    override public function create() {
        ...
        var charPlace:FlxSprite = new FlxSprite(30, 30).loadGraphic(Paths.image('menus/Selects/char_place_old'));
        charPlace.scale.set(0.5, 0.5);
        charPlace.updateHitbox();
        add(charPlace);

        iconSprite = new FlxSprite(charPlace.x + ((charPlace.x / 2) - 10), charPlace.y + ((charPlace.y / 2) - 10));
        add(iconSprite);

...
class Achievements {
	...
	{
		createAchievement('1000_flash', {name: "100 FLASH !!!", description: "Collect 100 Flash in the level."});
		createAchievement('secret_road', {name: "Different Road?", description: "Find secret road on Neon Level.", hidden: true});
		createAchievement('best_gamer', {name: "YOU PEAK !!!", description: "Beat the level lower than 15 seconds."});
		createAchievement('bad_gamer', {name: "You suck", description: "What will I say..."});
		createAchievement('complete_super', {name: "Getting Super", description: "Collect 7 Diamonds."});
		createAchievement('hamedo', {name: "Hello my Bro", description: "Unlock Hamedo on ATown Level."});
		createAchievement('zezo', {name: "ZEZO AZEZO", description: "Unlock Zezo on Nature Level."});
		createAchievement('m_shaban', {name: "Mohamed Sha'bula", description: "Unlock Shaban on Mountain Level."});
		createAchievement('win_boss', {name: "Take that, Lio!", description: "Beat Lio on his Boss Fight."});
		createAchievement('cool_guy', {name: "Oh yeah, Baby", description: "Dancing while fall from Space into Earth."});
		createAchievement('urgent', {name: "Wait for ME!!!", description: "Running while your Partner late."});
		createAchievement('debugger', {name: "Debugger", description: "Unlock debug mode.", hidden: true});
